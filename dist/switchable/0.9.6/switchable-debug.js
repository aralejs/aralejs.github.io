define("#switchable/0.9.6/switchable-debug", ["#jquery/1.7.2/jquery-debug", "#widget/0.9.16/widget-debug", "#base/0.9.16/base-debug", "#class/0.9.2/class-debug", "#events/0.9.1/events-debug", "#base/0.9.16/aspect-debug", "#base/0.9.16/attribute-debug", "#widget/0.9.16/daparser-debug", "#widget/0.9.16/auto-render-debug", "#switchable/0.9.6/const-debug", "#switchable/0.9.6/plugins/effects-debug", "#switchable/0.9.6/plugins/autoplay-debug", "#switchable/0.9.6/plugins/circular-debug", "#switchable/0.9.6/plugins/multiple-debug"], function(require, exports, module) {
    ...
    var Effects = require("#switchable/0.9.6/plugins/effects-debug");
    var Autoplay = require("#switchable/0.9.6/plugins/autoplay-debug");
    var Circular = require("#switchable/0.9.6/plugins/circular-debug");
    var Multiple = require("#switchable/0.9.6/plugins/multiple-debug");
...
define("#switchable/0.9.6/plugins/autoplay-debug", ["#jquery/1.7.2/jquery-debug"], function(require, exports, module) {
...
define("#switchable/0.9.6/plugins/effects-debug", ["#jquery/1.7.2/jquery-debug"], function(require, exports, module) {
...
define("#switchable/0.9.6/plugins/circular-debug", ["#jquery/1.7.2/jquery-debug", "#switchable/0.9.6/plugins/effects-debug"], function(require, exports, module) {

    var $ = require("#jquery/1.7.2/jquery-debug");

    var SCROLLX = 'scrollx';
    var SCROLLY = 'scrolly';
    var Effects = require("#switchable/0.9.6/plugins/effects-debug").Effects;
...
define("#switchable/0.9.6/plugins/multiple-debug", ["#switchable/0.9.6/const-debug"], function(require, exports, module) {
...
define("#switchable/0.9.6/const-debug", [], function(require, exports) {
