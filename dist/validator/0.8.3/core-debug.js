define("#validator/0.8.3/core-debug", ["#jquery/1.7.2/jquery-debug", "#widget/0.9.16/widget-debug", "#base/0.9.16/base-debug", "#class/0.9.2/class-debug", "#events/0.9.1/events-debug", "#base/0.9.16/aspect-debug", "#base/0.9.16/attribute-debug", "#widget/0.9.16/daparser-debug", "#widget/0.9.16/auto-render-debug", "#validator/0.8.3/async-debug", "#validator/0.8.3/utils-debug", "#validator/0.8.3/rule-debug", "#validator/0.8.3/item-debug"], function(require, exports, module) {

    var $ = require("#jquery/1.7.2/jquery-debug"),
        async = require("#validator/0.8.3/async-debug"),
        Widget = require("#widget/0.9.16/widget-debug"),
        utils = require("#validator/0.8.3/utils-debug"),
        Item = require("#validator/0.8.3/item-debug");
    ...
    var Core = Widget.extend({
        ...
        Statics: $.extend({helper: utils.helper}, require("#validator/0.8.3/rule-debug"), {
