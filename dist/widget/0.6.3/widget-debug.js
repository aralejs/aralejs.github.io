define("#widget/0.6.3/widget-debug", ["base","$","./daparser"], function(require, exports, module) {
    ...
    var Widget = Base.extend({
        ...
        parseDataAttrs: function() {
            if (this.options['data-api']) {
                ...
                this._parseDataActions();
            }
        },

        // 解析 data-action，添加到 this.events 中
        _parseDataActions: function() {
