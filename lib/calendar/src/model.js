define(function(require, exports, module) {
    ...
    function _prepareDates(cal, startDay) {
    ...
    function CalendarModel(cal) {
        var weeks = _prepareWeeks(cal);
        return {
            current: _prepareCurrent(cal),
            weeks: weeks,
            dates: _prepareDates(cal, weeks.start)
        };
    }
