define("#switchable/0.9.0/switchable-debug", ["jquery","underscore","widget","base","./extra/utils","./plugins/effects","./plugins/autoplay","./plugins/circular"], function(require, exports, module) {
    ...
    var Switchable = module.exports = Widget.extend({
        ...
        initProps: function() {
            this.delay = parseFloat(this.get('delay')) || 100;
            this.duration = parseFloat(this.get('duration')) || 300;
        },
        setup: function() {
            //初始化switchable相关数据结构。
            this._initPanels();
