define(function(require, exports, module) {
    ...
    var propertiesInOptions = ['element'];
    ...
    var Widget = Base.extend({
        ...
        // 提供给子类覆盖，负责 attributes 的初始化
        // attributes 是与实例相关的状态信息，可读可写，发生变化时，会自动触发相关事件
        // 可以将部分常用的 attributes 直接放在 this 上，转换成 properties
        initAttrs: function() {
        },
        ...
        // 提供给子类覆盖的初始化方法，此方法运行后，组件应处于 ready 状态
        setup: function() {
        },
