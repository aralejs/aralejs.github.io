    ...
    var Calendar = Overlay.extend({
        ...
        _keyDown: function(ev) {
            ...
            if (ev.shiftKey && keyboard === 'right') {
                ...
                this._dateKeyDown(keyboard);
            } else if (mode.month) {
                this._monthKeyDown(keyboard);
            } else if (mode.year) {
                this._yearKeyDown(keyboard);
            }
        },

        _dateKeyDown: function(keyboard) {
            if (keyboard === 'enter') {
                var date = this.model.selectDate();
                this._fillDate(date);
                return;
        ...
        _monthKeyDown: function(keyboard) {
            if (keyboard === 'enter') {
                var date = this.model.selectDate();
        ...
        _yearKeyDown: function(keyboard) {
            if (keyboard === 'enter') {
                var date = this.model.selectDate();
