    ...
    var Calendar = Overlay.extend({
        ...
        setup: function() {
            ...
            var hash = {
                ...
                'change:date': '[data-role=datalist]',
                'change:time': '[data-role=time]',
                'change:mode': ['[data-role=datalist]', '[data-role=control]']
            };
        ...
        _selectMonth: function(ev) {
            var el = $(ev.target);
            this.model._current.month(el.data('value'));
        ...
        _selectDate: function(ev) {
            var el = $(ev.target);
            var date = this.model.selectDate(el.data('date'), el.data('month'));
