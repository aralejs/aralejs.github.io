define("#validator/0.8.2/validator-mobile-debug", ["#widget/0.9.16/widget-debug", "#base/0.9.16/base-debug", "#class/0.9.2/class-debug", "#events/0.9.1/events-debug", "#base/0.9.16/aspect-debug", "#base/0.9.16/attribute-debug", "#zepto/0.8.0/zepto-debug", "#widget/0.9.16/daparser-debug", "#widget/0.9.16/auto-render-debug", "#validator/0.8.2/core-debug", "#validator/0.8.2/async-debug", "#validator/0.8.2/utils-debug", "#validator/0.8.2/rule-debug", "#validator/0.8.2/item-debug"], function(require, exports, module) {
    var Core = require("#validator/0.8.2/core-debug"),
