...
//        EVENT_REMOVED = 'removed';
    ...
    Effects.attrs = {
        ...
        fade: function(callback) {
            ...
            if (fromEl && fromEl.length > 0) {
                ...
                this.anim = $(fromEl).animate({
                    opacity: 0
                }, options.duration * 1000, options.easing, function() {
        ...
        scroll: function(callback, forceAnimation) {
            ...
            if (forceAnimation || fromIndex > -1) {
                this.anim = this.content.animate(props, duration, options.easing, function() {
                    that.anim = undefined; // free
                    callback && callback();
                });
             } else {
    ...
    Effects.attrs[SCROLLX] = Effects.attrs[SCROLLY] = Effects.attrs.scroll;
});
