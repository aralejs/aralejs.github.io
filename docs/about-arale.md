...
Arale 手下拥有 [events](http://aralejs.org/events/)、[widget](http://aralejs.org/widget/)、[popup](http://aralejs.org/popup/)、[validator](http://aralejs.org/validator/)、[autocomplete](http://aralejs.org/autocomplete/) 等等等等下流狡猾的模块喽啰们，他们手脚麻利，办事干净，各自独当一面讲义气，任你各种需求耀武扬威，上去就是一板砖，绝无二话。
