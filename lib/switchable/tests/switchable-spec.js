define(function(require) {
    ...
    describe('Switchable', function() {
        ...
        test('Carcousel', function() {
            ...
            expect($(cc2.prevBtn).attr('class')).toContain('ui-switchable-disable-btn');
            expect($(cc2.nextBtn).attr('class')).toEqual('next');

            cc2.switchTo(2);
            expect($(cc2.nextBtn).attr('class')).toContain('ui-switchable-disable-btn');
        ...
        test('插件安装', function() {
            ...
            expect(sw.get('plugins').length).toBe(3);
        });
