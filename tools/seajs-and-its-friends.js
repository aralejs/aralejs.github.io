...
seajs.config({
    ...
    alias: {
        ...
        'base': 'base/0.9.8/base',                           // 90%  完善阶段
        'widget': 'widget/0.9.5/widget',                     // 90%  完善阶段
        'widget-templatable': 'widget/0.9.5/templatable',    // 90%  完善阶段
        ...
        // Widgets
        'overlay': 'overlay/0.9.1/overlay',                  // 90%  完善阶段
        'mask': 'overlay/0.9.1/mask',                        // 90%  完善阶段
