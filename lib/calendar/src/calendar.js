...
define(function(require, exports, module) {
    ...
    var defaults = {
        ...
        // fill output with selected date.
        // if not specified, output will be trigger element.
        output: {
            value: 'trigger',
            getter: function(val) {
                if (val === 'trigger') return this.get('trigger');
                return val;
            }
        },
    ...
    var Calendar = Overlay.extend({
        ...
        _keyDown: function(ev) {
            ...
            if (ev.shiftKey && keyboard === 'right') {
                ...
                this.model.changeTime('days', 1);
            } else if (keyboard === 'left') {
                this.model.changeTime('days', -1);
            } else if (keyboard === 'up') {
                this.model.changeTime('days', -7);
