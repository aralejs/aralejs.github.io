define(function(require, exports, module) {
    ...
    var Switchable = module.exports = Widget.extend({
        ...
        _initPanels: function() {
            ...
            var panels = this.panels = this.$(options.panels);
            if (panels.length == 0) {
                //check contentClass.
        ...
        _initTriggers: function() {
            var nav, options = this.options;
            var triggers = this.triggers = this.$(options.triggers);
            var len;
        ...
        _postCreate: function() {
            ...
            var _circular = options.circular;
