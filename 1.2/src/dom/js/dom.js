...
define((function(require, exports, module){
  ...
  exportsObject.$$ = window.$$ = function(selector, context, results, seed){
    if(context) {
  ...
  exportsObject.$ = window.$  = function(id){
    if(!id)return null;
   ...
   exportsObject.filter_ = function(selector, eles) {
   return Sizzle.matches(selector, eles);
   };

  exportsObject.sizzle = Sizzle;



	module.exports = window.D = exportsObject;
