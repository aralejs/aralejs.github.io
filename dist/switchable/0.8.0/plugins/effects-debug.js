...
define("#switchable/0.8.0/plugins/effects-debug", ["jquery","../help/easing"], function(require, exports, module) {

    var $ = require('jquery');
    var _easing = require('../help/easing');
    ...
    var Effects = module.exports = {
            ...
            if (effect !== NONE) { // effect = scrollx, scrolly, fade
                ...
                switch (effect) {
                    ...
                    case SCROLLY:
                        ...
                        // 1. 获取高宽
                        this.viewSize = [
                            options.viewSize[0] || panels0 && panels0.offsetWidth * steps,
                            options.viewSize[1] || panels0 && panels0.offsetHeight * steps
                        ];
        ...
        fade: function(callback) {
            ...
            if (fromPanels && fromPanels.length !== 1) {
                alert('fade effect only supports steps == 1.');
            }
