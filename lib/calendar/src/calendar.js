...
define(function(require, exports, module) {
    ...
    var Calendar = Widget.extend({
        ...
        initOptions: function(options) {
            Calendar.superclass.initOptions.apply(this, options);
            ...
            this.model = prepareData(this._current, this.options.startDay);
        ...
        width: function(value) {
            return getOrSetOption(this, 'width', value);
        },
        height: function(value) {
            return getOrSetOption(this, 'height', value);
        },
        format: function(value) {
            return getOrSetOption(this, 'format', value);
        },
    ...
    function getOrSetOption(instance, name, value) {
        if (value === undefined) {
