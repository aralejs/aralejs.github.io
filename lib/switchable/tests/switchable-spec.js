define(function(require) {
    ...
    describe('Switchable', function() {
        ...
        beforeEach(function() {
            ...
            elem.push('<span id="scroller-prev" class="prev" data-role="prev">上一页</span>');
            elem.push('<span id="scroller-next" class="next" data-role="next">下一页</span>');
            elem.push('<ul class="ui-switchable-nav" data-role="nav"> ');
            elem.push('<li>NA</li>><li>NB</li>><li>NC</li></ul>');
            elem.push('<div class="ui-switchable-content" data-role="content">');
            ...
            elem3.push('<div class="ui-switchable-content" data-role="content">');
        ...
        test('Carousel', function() {
            ...
            var disabelClass = 'ui-switchable-disabled-button';
            expect($(cc2.get('prevButton')).attr('class')).toContain(disabelClass);

            cc2.switchTo(2);
            expect($(cc2.get('nextButton')).attr('class')).toContain(disabelClass);
