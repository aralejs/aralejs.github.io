define(function(require, exports, module) {
     ...
     * @param {Function|String} fn the function to execute or the name of the method in
     *        the 'o' object to execute.
     * @param {Number} when the number of milliseconds to wait until the fn is executed.
