define(function(require, exports, module) {
    ...
    function circularScroll(panelInfo) {
        ...
        // 在临界点时，先调整 panels 位置
        if (isCritical) {
            diff = adjustPosition.apply(this, isBackward, prop, viewDiff);
        }
        ...
        if (fromIndex > -1) {
            ...
            this.anim = this.content.animate(props, duration, easing,
                    function() {
                        ...
                        // 复原位置
                        if (isCritical) {
                            resetPosition.apply(that, isBackward,
                                    prop, viewDiff);
                        }
                    });
        }
