define(function(require) {
    ...
    describe('dropdown', function() {
        ...
        test('instance', function() {
            ...
            expect(test1.options.triggerType).toBe('mouseenter');
            expect(test1.options.offset).toEqual([0, 0]);
            expect(test1.options.zIndex).toBe(99);
            expect(test1.options.timeout).toBe(0.2);
            expect(test1.options.delay).toBe(0.1);
        });
