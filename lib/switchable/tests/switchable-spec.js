define(function(require) {
    ...
    describe('Switchable', function() {
        ...
        test('Carousel', function() {
            ...
            var disabelClass = 'ui-switchable-disable-button';
            expect($(cc2.prevButton).attr('class')).toContain(disabelClass);
            expect($(cc2.nextButton).attr('class')).toEqual('next');

            cc2.switchTo(2);
            expect($(cc2.nextButton).attr('class')).toContain(disabelClass);
            expect($(cc2.prevButton).attr('class')).toEqual('prev');
