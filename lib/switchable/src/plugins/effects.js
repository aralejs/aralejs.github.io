...
//        EVENT_REMOVED = 'removed';
            ...
            if (effect !== NONE) { // effect = scrollx, scrolly, fade
                ...
                switch (effect) {
                    ...
                    case SCROLLY:
                        ...
                        this.viewSize = [
                            _viewSize[0] || panels0 && panels0.offsetWidth * step,
                            _viewSize[1] || panels0 && panels0.offsetHeight * step
                        ];
    ...
    Effects.methods = {
        ...
        scroll: function(callback, forceAnimation) {
            ...
            if (forceAnimation || fromIndex > -1) {
                this.anim = this.content.animate(props, duration, this.get('easing'), function() {
                    that.anim = undefined; // free
                    callback && callback();
                });
             } else {
    ...
    Effects.methods[SCROLLX] = Effects.methods[SCROLLY] = Effects.methods.scroll;
});
